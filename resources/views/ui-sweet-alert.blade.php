                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
                            ...
                            <button type="button" class="btn btn-primary waves-effect waves-light" id="chaining-alert">Click
                                me</button>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
                            <p>Dynamic queue example</p>
                            <button type="button" class="btn btn-primary waves-effect waves-light" id="dynamic-alert">Click
                                me</button>
                        </div>
