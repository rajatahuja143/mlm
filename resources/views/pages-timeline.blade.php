                        ...
                        <ul class="timeline list-unstyled">
                            <li class="timeline-list">
                                <div class="cd-timeline-content p-4">
                                    ...
                                    <p class="mb-2">At vero eos et accusamus et iusto odio dignissimos ducimus qui
                                    ...
                                    <p class="mb-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                                        ...
                                        inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. enim
                            ...
                            <li class="timeline-list right clearfix">
                                <div class="cd-timeline-content p-4">
                                    ...
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                        ...
                                        architecto beatae vitae dicta sunt explicabo. enim ipsam voluptatem quia voluptas
                                        sit aspernatur aut odit aut fugit</p>
                                    <button type="button"
                                        class="btn btn-primary btn-rounded waves-effect waves-light m-t-5">See more
                                        detail</button>
                            ...
                            <li class="timeline-list right clearfix">
                                <div class="cd-timeline-content p-4">
                                    ...
                                    <p class="mb-2">It will be as simple as Occidental; in fact, it will be Occidental. To
                                        an English person, it will seem like simplified English, as a skeptical Cambridge
                                        friend of mine told me what Occidental</p>
                                    <p class="mb-0">languages are members of the same family. Their separate existence is a
                                        myth... <a href="#" class="text-primary">Read More</a></p>
