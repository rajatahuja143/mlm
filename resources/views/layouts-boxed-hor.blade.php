...
@section('title') @lang('translation.Boxed_Layout') @endsection
                        ...
                        <ol class="activity-feed">
                            ...
                            <li class="feed-item">
                                <div class="feed-item-list">
                                    ...
                                    <span class="activity-text">Sed ut perspiciatis omnis iste natus error sit rem.</span>
                                </div>
                            </li>
                        </ol>
                        <div class="text-center">
                        ...
                        <div class="card text-center">
                            <div class="card-body">
                                <div class="py-4">
                                    ...
                                    <p class="text-muted">Thanks you much for your order.</p>
                                    <div class="mt-4">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-3 pb-4">" Everyone realizes why a new common language would be
                                    desirable one could refuse to pay expensive translators it would be necessary. "</p>
                                <div class="float-right mt-2">
                                    <a href="#" class="text-primary">
                                        <i class="mdi mdi-arrow-right h5"></i>
                                    </a>
                                </div>
                                <h6 class="mb-0"><img src="{{ URL::asset('/assets/images/users/user-3.jpg') }}" alt=""
                            ...
                            <ul class="conversation-list" data-simplebar style="max-height: 367px;">
                                <li class="clearfix">
                                    <div class="chat-avatar">
                                        <img src="{{ URL::asset('/assets/images/users/user-2.jpg') }}" class="avatar-xs rounded-circle"
                                            alt="male">
                                ...
                                <li class="clearfix odd">
                                    <div class="chat-avatar">
                                        <img src="{{ URL::asset('/assets/images/users/user-3.jpg') }}" class="avatar-xs rounded-circle"
                                            alt="Female">
                                ...
                                <li class="clearfix odd">
                                    ...
                                    <div class="conversation-text">
                                        <div class="ctext-wrap">
                                            ...
                                            <img src="{{ URL::asset('/assets/images/small/img-1.jpg') }}" alt="" height="48"
                                                class="rounded mr-2">
