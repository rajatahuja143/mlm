...
@section('title') @lang('translation.Login_1') @endsection
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="p-3">
                                    <form class="form-horizontal mt-4" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="test@themesbrand.com" @endif id="username"
                                        ...
                                        <div class="form-group mt-2 mb-0 row">
                                            <div class="col-12 mt-4">
                                                <a href="pages-recoverpw"><i class="mdi mdi-lock"></i> Forgot your
                                                    password?</a>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="mt-5 text-center">
                            <p>Don't have an account ? <a href="pages-register" class="font-weight-medium text-primary">
                                    Signup now </a> </p>
                            <p class="mb-0">© <script>
