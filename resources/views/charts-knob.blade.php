...
@section('title') @lang('translation.Jquery_Knob_Chart') @endsection
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        <div class="col-lg-4 text-center" dir="ltr">
                            ...
                            <input class="knob" data-width="150" data-fgcolor="#3c4ccf" data-displayinput="false"
                                value="35">
                        </div>
                        <div class="col-lg-4 text-center" dir="ltr">
                        ...
                        <div class="col-lg-4 text-center" dir="ltr">
                            ...
                            <input class="knob" data-width="150" data-min="-100" data-fgcolor="#ffbb44"
                    ...
                    <div class="row">
                        <div class="col-lg-4 text-center" dir="ltr">
                            ...
                            <input class="knob" data-width="150" data-height="150" data-linecap=round data-fgColor="#38a4f8"
                                value="80" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".1" />
                        </div>
                        <div class="col-lg-4 text-center" dir="ltr">
                            <h5 class="font-size-16 mb-3"> Angle offset and arc</h5>
