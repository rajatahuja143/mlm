...
@section('title') @lang('translation.Directory') @endsection
    ...
    <div class="row">
        <div class="col-xl-4 col-md-6">
            <div class="card directory-card">
                <div class="card-body">
                    ...
                    <hr>
                    <p class="mb-0"><b>Intro : </b>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                        atque corrupti quos dolores et... <a href="#" class="text-primary"> Read More</a></p>
                </div>
            </div>
        </div>
        <!-- end col -->
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card directory-card">
                <div class="card-body">
                    <div class="media">
                        <img src="{{ URL::asset('/assets/images/users/user-7.jpg') }}" alt=""
                            class="img-fluid img-thumbnail rounded-circle avatar-lg">
                        <div class="media-body ml-3">
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card directory-card">
                <div class="card-body">
                    <div class="media">
                        <img src="{{ URL::asset('/assets/images/users/user-8.jpg') }}" alt=""
                            class="img-fluid img-thumbnail rounded-circle avatar-lg">
                        <div class="media-body ml-3">
                            <h5 class="text-primary font-size-18 mt-0 mb-1">Jerome A. Hebert</h5>
                            <p class="font-size-12 mb-2">Creative Director</p>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card directory-card">
                ...
                <div class="card-body">
                    <div class="media">
                        <img src="{{ URL::asset('/assets/images/users/user-10.jpg') }}" alt=""
                            class="img-fluid img-thumbnail rounded-circle avatar-lg">
                        <div class="media-body ml-3">
