    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Form Advanced</h4>
                    ...
                    <form action="#">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group colorpicker-default" title="Using format option">
                                <input type="text" class="form-control input-lg" value="#626ed4" />
                        ...
                        <div class="form-group">
                            ...
                            <div id="colorpicker-color-pattern" class="input-group colorpicker-component">
                                <input type="text" class="form-control input-lg" value="#337ab7" />
                                <span class="input-group-append">
                                    <span class="input-group-text colorpicker-input-addon"><i></i></span>
                                </span>
                            </div>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input type="text" class="colorpicker-large form-control" value="#626ed4">
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input id="demo0" type="text" value="55" name="demo0" data-bts-min="0" data-bts-max="100"
